            ...
            <div class="recent-post-info">
              ...
              <div class="article-meta-wrap">
                ...
                <span class="post-meta-date">
                  ...
                  <span class="article-meta-label">published on</span>
                  <span class="post-meta-date-created">{{blog.create_time}}</span>
                  <span class="article-meta__separator">|</span>
                  <i class="el-icon-time"></i>
                  <span class="article-meta-label">Update on</span>
                ...
                <span class="article-meta">
                  ...
                  <span class="valine-comment-count">read：{{blog.blog_visits}}</span>
                </span>
                ...
                <span class="article-meta">
                  ...
                  <span class="article-meta-label">comments</span>
                </span>
                <span class="article-meta">
                  <span class="article-meta__separator">|</span>
                  <i class="el-icon-star-on"></i>
                  <span class="valine-comment-count">Likes：{{blog.blog_like}}</span>
                </span>
              </div>
        ...
        this.$axios
          ...
          .then(res => {
            ...
            if (res.data.data) {
              ...
              _this.titleinfo = res.data.data[0].category_name + "Classification of articles";
            } else {
              _this.$message.warning("There are no articles under this category");
            }
          });
           document.title = "Classification of articles"
      } else if (type == "tag") {
        this.$axios
          ...
          .then(res => {
            ...
            if (res.data.data) {
              ...
              _this.currentPage = res.data.currentPage;
              _this.total = res.data.totalPage;
              _this.titleinfo = res.data.data[0].tag_name + "Under the tag";
            } else {
              _this.$message.warning("Under the tag");
            }
          });
          document.title = "Tags under the article"
      }
    }
  },
  watch: {
