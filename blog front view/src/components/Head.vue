  ...
  <div>
    <div class="headBack">
      ...
      >
        <el-menu-item
          index="/home"
          class="mr-auto hidden-sm-and-down"
          style="color: #409eff; font-size: 25px"
          >{{ siteInfo.blogName }}</el-menu-item
        >
        ...
        <el-submenu index class="hidden-sm-and-down">
          ...
          >
            <router-link
              :to="{
                name: 'list',
                params: { type: 'category', id: category.category_id },
              }"
              tag="span"
        ...
        <el-menu-item index="/moment">dynamic</el-menu-item>
        <el-menu-item index="/friends">Friends Link</el-menu-item>
